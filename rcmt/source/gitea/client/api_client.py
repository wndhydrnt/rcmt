...
import rcmt.source.gitea.client.models
from rcmt.source.gitea.client import rest
from rcmt.source.gitea.client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(rcmt.source.gitea.client.models, klass)
