...
from rcmt.source.gitea.client.models.payload_user import PayloadUser  # noqa: E501
...
class TestPayloadUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = rcmt.source.gitea.client.models.payload_user.PayloadUser()  # noqa: E501
        if include_optional :
            return PayloadUser(
                email = '', 
                name = '', 
