...
from rcmt.source.gitea.client.models.gpg_key_email import GPGKeyEmail  # noqa: E501
...
class TestGPGKeyEmail(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = rcmt.source.gitea.client.models.gpg_key_email.GPGKeyEmail()  # noqa: E501
        if include_optional :
            return GPGKeyEmail(
                email = '', 
                verified = True
