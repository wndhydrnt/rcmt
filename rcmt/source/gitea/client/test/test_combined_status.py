...
from rcmt.source.gitea.client.models.combined_status import CombinedStatus  # noqa: E501
...
class TestCombinedStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = rcmt.source.gitea.client.models.combined_status.CombinedStatus()  # noqa: E501
        if include_optional :
            return CombinedStatus(
                commit_url = '', 
                repository = rcmt.source.gitea.client.models.repository.Repository(
                ...
                state = '', 
                statuses = [
                    rcmt.source.gitea.client.models.commit_status.CommitStatus(
                        context = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        creator = rcmt.source.gitea.client.models.user.User(
                            active = True, 
                            avatar_url = '', 
                            created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            description = '', 
