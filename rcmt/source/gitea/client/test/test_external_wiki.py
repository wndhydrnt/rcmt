...
from rcmt.source.gitea.client.models.external_wiki import ExternalWiki  # noqa: E501
...
class TestExternalWiki(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = rcmt.source.gitea.client.models.external_wiki.ExternalWiki()  # noqa: E501
        if include_optional :
            return ExternalWiki(
                external_wiki_url = ''
            )
