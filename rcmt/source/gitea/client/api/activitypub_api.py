...
class ActivitypubApi(object):
    ...
    def activitypub_person_with_http_info(self, username, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('username') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `username` when calling `activitypub_person`")  # noqa: E501
    ...
    def activitypub_person_inbox_with_http_info(self, username, **kwargs):  # noqa: E501
        ...
        # verify the required parameter 'username' is set
        if self.api_client.client_side_validation and local_var_params.get('username') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `username` when calling `activitypub_person_inbox`")  # noqa: E501
