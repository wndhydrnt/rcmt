...
class ContentsResponse(object):
    ...
    def __init__(self, links=None, content=None, download_url=None, encoding=None, git_url=None, html_url=None, last_commit_sha=None, name=None, path=None, sha=None, size=None, submodule_git_url=None, target=None, type=None, url=None, local_vars_configuration=None):  # noqa: E501
        """ContentsResponse - a model defined in OpenAPI"""  # noqa: E501
