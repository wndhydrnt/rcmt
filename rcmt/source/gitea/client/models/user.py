...
class User(object):
    ...
    def __init__(self, active=None, avatar_url=None, created=None, description=None, email=None, followers_count=None, following_count=None, full_name=None, id=None, is_admin=None, language=None, last_login=None, location=None, login=None, login_name='empty', prohibit_login=None, restricted=None, starred_repos_count=None, visibility=None, website=None, local_vars_configuration=None):  # noqa: E501
