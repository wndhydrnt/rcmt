...
class Package(object):
    ...
    def __init__(self, created_at=None, creator=None, id=None, name=None, owner=None, repository=None, type=None, version=None, local_vars_configuration=None):  # noqa: E501
