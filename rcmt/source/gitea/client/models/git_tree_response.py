...
class GitTreeResponse(object):
    ...
    def __init__(self, page=None, sha=None, total_count=None, tree=None, truncated=None, url=None, local_vars_configuration=None):  # noqa: E501
        """GitTreeResponse - a model defined in OpenAPI"""  # noqa: E501
