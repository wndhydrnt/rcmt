...
class UpdateFileOptions(object):
    ...
    def __init__(self, author=None, branch=None, committer=None, content=None, dates=None, from_path=None, message=None, new_branch=None, sha=None, signoff=None, local_vars_configuration=None):  # noqa: E501
        """UpdateFileOptions - a model defined in OpenAPI"""  # noqa: E501
