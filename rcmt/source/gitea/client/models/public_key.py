...
class PublicKey(object):
    ...
    def __init__(self, created_at=None, fingerprint=None, id=None, key=None, key_type=None, read_only=None, title=None, url=None, user=None, local_vars_configuration=None):  # noqa: E501
