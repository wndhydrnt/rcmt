...
class DeleteFileOptions(object):
    ...
    def __init__(self, author=None, branch=None, committer=None, dates=None, message=None, new_branch=None, sha=None, signoff=None, local_vars_configuration=None):  # noqa: E501
        """DeleteFileOptions - a model defined in OpenAPI"""  # noqa: E501
