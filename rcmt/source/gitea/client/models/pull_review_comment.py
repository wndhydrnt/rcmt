...
class PullReviewComment(object):
    ...
    def __init__(self, body=None, commit_id=None, created_at=None, diff_hunk=None, html_url=None, id=None, original_commit_id=None, original_position=None, path=None, position=None, pull_request_review_id=None, pull_request_url=None, resolver=None, updated_at=None, user=None, local_vars_configuration=None):  # noqa: E501
        """PullReviewComment - a model defined in OpenAPI"""  # noqa: E501
