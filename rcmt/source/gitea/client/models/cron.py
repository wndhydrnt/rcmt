...
class Cron(object):
    ...
    def __init__(self, exec_times=None, name=None, next=None, prev=None, schedule=None, local_vars_configuration=None):  # noqa: E501
        """Cron - a model defined in OpenAPI"""  # noqa: E501
