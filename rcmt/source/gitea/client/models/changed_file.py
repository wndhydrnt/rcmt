...
class ChangedFile(object):
    ...
    def __init__(self, additions=None, changes=None, contents_url=None, deletions=None, filename=None, html_url=None, previous_filename=None, raw_url=None, status=None, local_vars_configuration=None):  # noqa: E501
        """ChangedFile - a model defined in OpenAPI"""  # noqa: E501
