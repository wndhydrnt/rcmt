...
class TopicResponse(object):
    ...
    def __init__(self, created=None, id=None, repo_count=None, topic_name=None, updated=None, local_vars_configuration=None):  # noqa: E501
        """TopicResponse - a model defined in OpenAPI"""  # noqa: E501
