...
class WikiCommit(object):
    ...
    def __init__(self, author=None, commiter=None, message=None, sha=None, local_vars_configuration=None):  # noqa: E501
        """WikiCommit - a model defined in OpenAPI"""  # noqa: E501
