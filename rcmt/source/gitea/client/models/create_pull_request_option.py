...
class CreatePullRequestOption(object):
    ...
    def __init__(self, assignee=None, assignees=None, base=None, body=None, due_date=None, head=None, labels=None, milestone=None, title=None, local_vars_configuration=None):  # noqa: E501
        """CreatePullRequestOption - a model defined in OpenAPI"""  # noqa: E501
