...
class NotificationThread(object):
    ...
    def __init__(self, id=None, pinned=None, repository=None, subject=None, unread=None, updated_at=None, url=None, local_vars_configuration=None):  # noqa: E501
        """NotificationThread - a model defined in OpenAPI"""  # noqa: E501
