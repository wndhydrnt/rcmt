...
class RepoCommit(object):
    ...
    def __init__(self, author=None, committer=None, message=None, tree=None, url=None, verification=None, local_vars_configuration=None):  # noqa: E501
        """RepoCommit - a model defined in OpenAPI"""  # noqa: E501
