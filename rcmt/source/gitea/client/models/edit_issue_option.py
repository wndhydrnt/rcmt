...
class EditIssueOption(object):
    ...
    def __init__(self, assignee=None, assignees=None, body=None, due_date=None, milestone=None, ref=None, state=None, title=None, unset_due_date=None, local_vars_configuration=None):  # noqa: E501
        """EditIssueOption - a model defined in OpenAPI"""  # noqa: E501
