...
class CreatePullReviewComment(object):
    ...
    def __init__(self, body=None, new_position=None, old_position=None, path=None, local_vars_configuration=None):  # noqa: E501
        """CreatePullReviewComment - a model defined in OpenAPI"""  # noqa: E501
