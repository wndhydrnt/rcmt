...
class GitEntry(object):
    ...
    def __init__(self, mode=None, path=None, sha=None, size=None, type=None, url=None, local_vars_configuration=None):  # noqa: E501
        """GitEntry - a model defined in OpenAPI"""  # noqa: E501
