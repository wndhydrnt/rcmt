...
class NodeInfoUsageUsers(object):
    ...
    def __init__(self, active_halfyear=None, active_month=None, total=None, local_vars_configuration=None):  # noqa: E501
        """NodeInfoUsageUsers - a model defined in OpenAPI"""  # noqa: E501
