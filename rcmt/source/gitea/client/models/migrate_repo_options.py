...
class MigrateRepoOptions(object):
    ...
    def __init__(self, auth_password=None, auth_token=None, auth_username=None, clone_addr=None, description=None, issues=None, labels=None, lfs=None, lfs_endpoint=None, milestones=None, mirror=None, mirror_interval=None, private=None, pull_requests=None, releases=None, repo_name=None, repo_owner=None, service=None, uid=None, wiki=None, local_vars_configuration=None):  # noqa: E501
        """MigrateRepoOptions - a model defined in OpenAPI"""  # noqa: E501
    ...
    def clone_addr(self, clone_addr):
        ...
        :type clone_addr: str
        """
        if self.local_vars_configuration.client_side_validation and clone_addr is None:  # noqa: E501
