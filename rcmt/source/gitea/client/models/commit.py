...
class Commit(object):
    ...
    def __init__(self, author=None, commit=None, committer=None, created=None, files=None, html_url=None, parents=None, sha=None, stats=None, url=None, local_vars_configuration=None):  # noqa: E501
