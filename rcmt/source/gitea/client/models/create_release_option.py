...
class CreateReleaseOption(object):
    ...
    def __init__(self, body=None, draft=None, name=None, prerelease=None, tag_name=None, target_commitish=None, local_vars_configuration=None):  # noqa: E501
        """CreateReleaseOption - a model defined in OpenAPI"""  # noqa: E501
