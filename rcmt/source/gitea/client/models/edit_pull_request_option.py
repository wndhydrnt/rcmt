...
class EditPullRequestOption(object):
    ...
    def __init__(self, allow_maintainer_edit=None, assignee=None, assignees=None, base=None, body=None, due_date=None, labels=None, milestone=None, state=None, title=None, unset_due_date=None, local_vars_configuration=None):  # noqa: E501
        """EditPullRequestOption - a model defined in OpenAPI"""  # noqa: E501
