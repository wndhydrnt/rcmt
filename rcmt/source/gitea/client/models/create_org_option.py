...
class CreateOrgOption(object):
    ...
    def __init__(self, description=None, full_name=None, location=None, repo_admin_change_team_access=None, username=None, visibility=None, website=None, local_vars_configuration=None):  # noqa: E501
        """CreateOrgOption - a model defined in OpenAPI"""  # noqa: E501
