...
class CreateIssueOption(object):
    ...
    def __init__(self, assignee=None, assignees=None, body=None, closed=None, due_date=None, labels=None, milestone=None, ref=None, title=None, local_vars_configuration=None):  # noqa: E501
        """CreateIssueOption - a model defined in OpenAPI"""  # noqa: E501
