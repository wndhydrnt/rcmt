...
class TrackedTime(object):
    ...
    def __init__(self, created=None, id=None, issue=None, issue_id=None, time=None, user_id=None, user_name=None, local_vars_configuration=None):  # noqa: E501
        """TrackedTime - a model defined in OpenAPI"""  # noqa: E501
